...
## Fork-specific project notes (matalvernaz/BookPlayer)
...
- **Upstream:** TortugaPower/BookPlayer. Multi-server work *does* go
  upstream now: #1491 (multi-server), #1503, #1524 and #1565 are merged;
  #1510, #1516, #1566 and #1567 are open. Still fork-only: Hummingbird/NNELS,
  the Audiobookshelf share-link flow, the FLAC/bound-book seek stack, and the
  Pro-gating bypasses — those last ones must never appear in an upstream PR.
